export const zhCN = {
  ...
  sources: {
    ...
    statusEmbeddingDesc: "正在生成向量嵌入以支持语义搜索",
    ...
    preparing: "正在准备...",
    generateNewInsight: "生成新摘要",
    selectTransformation: "选择转换规则...",
    noInsightsYet: "暂无摘要",
    createFirstInsight: "使用上方的转换规则创建您的第一条摘要",
    viewInsight: "查看摘要",
    deleteInsight: "删除摘要",
    deleteInsightConfirm: "确定要删除这条摘要吗？此操作无法撤销。",
    insightGenerationStarted: "摘要生成已开始，稍后将显示。",
    editNote: "编辑笔记",
    createNote: "创建笔记",
    addTitle: "添加标题...",
    untitledNote: "无标题笔记",
    ...
    saveNote: "保存笔记",
    createNoteBtn: "创建笔记",
    createFirstNote: "创建您的第一条笔记，记录摘要与观察。",
    urlLabel: "URL(s) *",
    fileLabel: "文件(s) *",
  ...
  searchPage: {
    ...
    tasks: "任务",
    runningTasks: "进行中的任务",
    runningTasksDesc: "当前正在执行的 Deep Research 任务",
  ...
  settings: {
    ...
    embeddingBatchSizeHelp: "每次调用嵌入 API 时发送的文本数量。如果您的嵌入服务有批量限制（例如最多 32 条），请将此值设为不超过该限制。默认值：32。",
    embeddingChunkSize: "嵌入分块大小（字符数）",
    embeddingChunkSizeHelp: "将长文本切分为较小的块进行嵌入时，每个块的最大字符数。如果您的嵌入模型有 token 上限（如 512 token），请减小此值以确保每个块不超过限制。中文约 1 字符 ≈ 1 token。默认值：500。",
    fileManagement: "文件管理",
    ...
    maxConcurrentTasks: "每用户最大 Deep Research 任务数",
    maxConcurrentTasksHelp: "限制每个用户同时进行的 Deep Research 任务数量。超过限制时新任务将被拒绝。默认：5",
  },
  advanced: {
    title: "高级工具",
    desc: "面向进阶用户的调试和实用工具",
  ...
  transformations: {
    title: "内容转换规则",
    desc: "转换规则是用于让大模型处理来源并提取摘要、要点等内容的提示词。",
    workspace: "选择工作区",
    playground: "实验室",
    ...
    promptHint: "提示词应根据源内容编写。您可以要求模型总结、提炼摘要或生成表格等结构化输出。",
  ...
  models: {
    ...
    transformationModelDesc: "用于摘要、内容提炼和转换",
