export const ptBR = {
  ...
  admin: {
    ...
    desc: "Gerenciar contas de usuário e permissões",
    ...
    deleteConfirm: "Tem certeza de que deseja excluir o usuário \"{name}\"? Esta ação não pode ser desfeita.",
    userCreated: "Usuário \"{name}\" criado com sucesso",
    userDeleted: "Usuário \"{name}\" excluído com sucesso",
    ...
    creating: "Criando...",
    cannotDeleteAdmin: "Não é possível excluir o usuário admin",
    userAlreadyExists: "O usuário \"{name}\" já existe",
  },
  setupBanner: {
    encryptionRequired: "Chave de criptografia não configurada",
